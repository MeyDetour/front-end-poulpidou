...
const Configuration = () => {
    ...
    useEffect(() => {
            ...
            getSettings()
                .then(res => {
                    setData(res.value)
                    setValue("formatDate",res.value.formatDate)
                    setValue("payments",res.value.payments)
                    setValue("delayDays",res.value.delayDays)
                    setValue("installmentPayments",res.value.installmentPayments)
                    setValue("freeMaintenance",res.value.freeMaintenance)
                ...
                <div className="scroll-container">
                    <div className="conditions-of-payement__content">
                        <section>
                            ...
                            <p>In the event of a late payment, project delivery may be delayed, potentially extending
                        ...
                        <section>
                            ...
                            <ul>
                                <li><u>Full Refund:</u> If the project is canceled before work begins, a full refund may
                                    be issued.
                                </li>
                                <li><u>Partial Refund:</u> If the project is canceled after work has started, a partial
                                    refund reflecting the work completed may be considered.
                                </li>
                                <li><u>No Refund:</u> No refund may be provided if a significant portion of the project
                                    has been completed.
                                </li>
                            </ul>
                        </section>
                        <section>
                            ...
                            <p>In case of non-payment, no penalty fees will be charged, but services will be suspended
                        ...
                        <section>
                            ...
                            <p>Both parties agree to maintain confidentiality of all proprietary and sensitive
                                information disclosed during the project. This agreement remains in effect even after
                                the project is completed.</p>
                        </section>
                        <section>
                            <span>Contract Termination Conditions</span>
                            <p><u>Breach of Contract:</u> The contract may be terminated if either party fails to meet
                        ...
                        <section>
                            ...
                            <ul>
                                <li><u>Initial Deposit:</u> A percentage of the total cost paid upfront to initiate the
                                    project.
                                </li>
                                    ...
                                    <div className="conditions-of-payement__content">
                                                    ...
                                                    [30, 50, 60].map((val) => {
                                                        return (
                                                            <div className="flex-row" key={val}>
                                                                <InputRadio id={"net-" + val} name="delayDays"
                                                                            value={val}/>
                                                                <label htmlFor={"net-" + val}>Net {val}: Payment
                                                                    due {val} days after the invoice date.</label>
                                                            </div>
                                                        );
                                                    })
                                                }
                                        ...
                                        <section>
                                            ...
                                            <div className="flex-row">
                                                ...
                                                <label htmlFor="installmentPayments">Users can opt for installment
                                                    payments if they prefer not to pay in a single transaction.</label>
                                            </div>
                                        </section>
                                        <section>
                                            ...
                                            <div className="flex-row">
                                                ...
                                                <label htmlFor="freeMaintenance">Free maintenance is included for the
                                                    first year starting from the project initiation date.</label>
                                            </div>
                                        </section>
                                        <section>
                                            <span>Accepted Payment Delays</span>
