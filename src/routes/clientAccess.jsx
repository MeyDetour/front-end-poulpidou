...
const ClientAccess = () => {
    ...
    const association = {
        "CHEQUE": "Chèque", "CASH": "Espèce", "BANKTRANSFER": "Virement",
    }
    ...
    const deviceAssociationName = {
        "mobile": "Smart Phone", "computer": "Ordinateur", "television": "Télévision", "printer": "Impression"
    };
    const frameworkAssociationName = {
        "symfony": "Symfony", "django": "Django", "react": "React", "vue": "Vue.js", "angular": "Angular"
    };
        ...
        sendMessage(content, uuid)
            .then(res => {
                ...
                setMessages([...messages, {
                    content: content, datetime: "02/08/2024 16:00", author: {
    ...
    const projectDataPanel = useRef();
    useEffect(() => {
        const handleResize = () => {
            if (window.innerWidth <= 850) {
                setDisplayMessagerie(false);
                setDisplayOptions(false);
                setDisplayConditions(false);
                setDisplayProjectData(true)
            } else {
                // Si tu veux réactiver ces éléments quand la largeur dépasse 850
                setDisplayMessagerie(true);
                ...
                <Beforeunload onBeforeUnload={() => setOfflineBeforeUnload()}>
                    ...
                    <div className={"clientInterface"}>
                        <div className={"clientInterface-container flex-row"}>
                            {displayMessagerie ? <div className={"clientInterface-messagerie"}>
                            ...
                            {displayOptions ? <div className={"clientInterface-project-options"}>
                                {data.project?.database || data.project?.maquette || data.project?.maintenance || data.project?.options.length != 0 || data.project?.devices.length != 0 || data.project?.type.length != 0 || data.project?.framework.length != 0 ? <>
                                    ...
                                    </> : null} {data.project?.database || data.project?.options.length != 0 || data.project?.maquette || data.project?.maintenance ? <>
                                    <div className={"oneDetail"}>
                                        <h4>Options</h4>
                                        <div className={"separateur"}></div>
                                        {data.project?.database ? <span>Base de donnée</span> : null}
                                        {data.project?.maquette ? <span>Prototype & plan du site & design</span> : null}
                                        {data.project?.maintenance ? <span>Maintenance</span> : null}
                                        {data.project?.options.length != 0 ? (data.project?.options).map((option, index) => {
                                    ...
                                    </> : null} {data.project?.framework.length != 0 ? <>
                                    <div className={"oneDetail"}>
                                        <h4>Technologies</h4>
                                        <div className={"separateur"}></div>
                        ...
                        {displayConditions ? <div className="clientInterface-container ">
                            <div className="clientInterface-payment-conditions">
                                ...
                                <section>
                                    ...
                                    <p>In case of disagreement, parties will attempt to resolve the issue amicably
                                        through
                                        discussion and negotiation. If unresolved, parties may choose to engage a
                                        neutral
                                ...
                                <section>
                                    ...
                                    <ul>
                                        <li><u>Full Refund:</u> If the project is canceled before work begins, a full
                                            refund
                                            may
                                            be issued.
                                        </li>
                                ...
                                <section>
                                    ...
                                    <p><u>Breach of Contract:</u> The contract may be terminated if either party fails
                                        to
                                        meet
                                    ...
                                    <p><u>Mutual Agreement:</u> The contract can be terminated at any time if both
                                        parties
                                        agree.</p>
                                </section>
                                <section>
                                    ...
                                    <ul>
                                        <li><u>Initial Deposit:</u> A percentage of the total cost paid upfront to
                                            initiate
                                            the
                                            project.
                                        </li>
                                        <li><u>Progress Payments:</u> Payments made at specific stages of project
                                            completion
                                            (e.g., 25%, 50%, and 75% completion).
                                        </li>
                                        <li><u>Final Payment:</u> The remaining balance is due upon project completion
                                            and
                                            client approval.
                                        </li>
                                    </ul>
                        ...
                        <nav className={"clientInterface-nav"}>
                            <ul>
                                <li>
                                    <div onClick={() => {
                                        closePanels()
                                        setDisplayOptions(true)
                                    }} className={"clientInterface-project-icon clientInterface-project-icon__options "}>
                                        <img src="pictures/icons/list-columns-reverse.svg" alt=""/>
                                    </div>
                                </li>
                                <li>
                                    <div onClick={() => {
                                        ...
                                        setDisplayConditions(true)
                                         ...
                                         className={"clientInterface-project-icon clientInterface-project-icon__conditions"}>
                                        <img src="pictures/icons/exclamation-diamond-fill.svg" alt=""/>
                                ...
                                <li>
                                    <div onClick={() => {
                                        ...
                                        setDisplayMessagerie(true)
                                         ...
                                         className={"clientInterface-project-icon clientInterface-project-icon__messagerie"}>
                                        <img src="pictures/icons/message.svg" alt=""/>
                                ...
                                <li>
                                    <div onClick={() => {
                                        closePanels()
                                        setDisplayProjectData(true)
                                    }} className={"clientInterface-project-icon "}>
                                        <img src="pictures/icons/file-earmark-medical.svg" alt=""/>
                        ...
                        {displayProjectData ? <div className={"clientInterface-project-data"} ref={projectDataPanel}>
                                    <span onClick={() => {
                                        setDisplayProjectData(false)
                                        setDisplayMessagerie(true)
                                    }} className={"clientInterface-project-data-icon"}>
                                        X </span>
                            ...
                            <span>{data.modalites?.payments.length !== 0 ? "Moyens de paiements acceptés : " + data.modalites?.payments.map((methode, index) => association[methode] || methode).join(", ") : ""}</span>
                        </div> : null}
